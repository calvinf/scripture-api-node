...
class Fetch {
     ...
     */
    static bibleBook(apiKey: string, bibleId: string, bookId: string, params: BibleBookParams) {
    ...
    static bibleBookChapters(apiKey: string, bibleId: string, bookId: string) {
        const url = `${ApiEnum.baseUrl}${ApiEnum.bibles}/${bibleId}/books/${bookId}/chapters`;
        return fetch(url, getFetchOptions(apiKey));
    }
     ...
     */
    static bibleBookChapter(apiKey: string, bibleId: string, chapterId: string, params?: CommonFetchParams) {
        const url = this._getLongUrl(`${ApiEnum.baseUrl}${ApiEnum.bibles}/${bibleId}/chapters/${chapterId}`, params);
        return fetch(url, getFetchOptions(apiKey));
    }
     ...
     */
    static biblePassage(apiKey: string, bibleId: string, passageId: string, params: CommonFetchParams = {}) {
        const url = this._getLongUrl(`${ApiEnum.baseUrl}${ApiEnum.bibles}/${bibleId}/passages/${passageId}`, params);
     ...
     */
    static bibleBookSections(apiKey: string, bibleId: string, bookId: string, params: CommonFetchParams = {}) {
     ...
     */
    static bibleChapterSections(apiKey: string, bibleId: string, chapterId: string) {
     ...
     */
    static bibleSection(apiKey: string, bibleId: string, sectionId: string, params: CommonFetchParams = {}) {
     ...
     */
    static bibleChapterVerses(apiKey: string, bibleId: string, chapterId: string) {
        const url = `${ApiEnum.baseUrl}${ApiEnum.bibles}/${bibleId}/chapters/${chapterId}/verses`;
        return fetch(url, getFetchOptions(apiKey));
    }
     ...
     */
    static bibleVerse(apiKey: any, bibleId: any, verseId: any, params: CommonFetchParams = {}) {
        const url = this._getLongUrl(`${ApiEnum.baseUrl}${ApiEnum.bibles}/${bibleId}/verses/${verseId}`, params);
        return fetch(url, getFetchOptions(apiKey));
    }
    ...
    static _getLongUrl(link: string, params: CommonFetchParams = {}) {
        ...
        if (contentType && ['json', 'html', 'text'].includes(contentType.toLowerCase())) {
